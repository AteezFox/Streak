import { IconButton, Badge, Drawer, Container, Typography, Button, Box} from "@mui/material";
            ...
            <Drawer variant="temporary" anchor="bottom" open={isSideOpen} onClose={toggleSide} className={styles.drawer}>
                <Container className={styles.container}>
                    <Box className={styles.body}>
                        ...
                        <Button onClick={() => {summary("/summary")}}>Fizetés</Button>
                    </Box>
                </Container>
            </Drawer>
        </>
